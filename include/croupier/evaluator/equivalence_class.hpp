...
inline std::unordered_map<std::int32_t, hand_evaluation> make_two_card_equivalence_classes          ()
{
...
inline std::unordered_map<std::int32_t, hand_evaluation> make_three_card_equivalence_classes        ()
{
  auto map   = std::unordered_map<std::int32_t, hand_evaluation>();
  auto ranks = std::vector<rank>
  {
...
inline std::unordered_map<std::int32_t, hand_evaluation> make_four_card_equivalence_classes         ()
{
  auto map   = std::unordered_map<std::int32_t, hand_evaluation>();
  auto ranks = std::vector<rank>
  {
