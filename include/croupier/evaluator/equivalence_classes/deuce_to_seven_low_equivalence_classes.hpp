#ifndef CROUPIER_EVALUATOR_EQUIVALENCE_CLASSES_DEUCE_TO_SEVEN_LOW_EQUIVALENCE_CLASSES_HPP
#define CROUPIER_EVALUATOR_EQUIVALENCE_CLASSES_DEUCE_TO_SEVEN_LOW_EQUIVALENCE_CLASSES_HPP
...
{
template <>
inline std::unordered_map<std::int32_t, hand_evaluation> make_equivalence_classes<ranking_type::deuce_to_seven_low, 1>()
{
...
template <>
inline std::unordered_map<std::int32_t, hand_evaluation> make_equivalence_classes<ranking_type::deuce_to_seven_low, 2>()
{
  auto       map   = std::unordered_map<std::int32_t, hand_evaluation>();
  const auto ranks = std::vector
  {
...
template <>
inline std::unordered_map<std::int32_t, hand_evaluation> make_equivalence_classes<ranking_type::deuce_to_seven_low, 3>()
{
  auto       map   = std::unordered_map<std::int32_t, hand_evaluation>();
  const auto ranks = std::vector
  {
...
template <>
inline std::unordered_map<std::int32_t, hand_evaluation> make_equivalence_classes<ranking_type::deuce_to_seven_low, 4>()
{
  auto       map   = std::unordered_map<std::int32_t, hand_evaluation>();
  const auto ranks = std::vector
  {
...
template <>
inline std::unordered_map<std::int32_t, hand_evaluation> make_equivalence_classes<ranking_type::deuce_to_seven_low, 5>()
{
  auto       map       = std::unordered_map<std::int32_t, hand_evaluation>();
  const auto ranks     = std::vector
  {
